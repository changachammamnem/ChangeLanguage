...
public class HandlerSendMessageActivity extends AppCompatActivity {
        ...
        handler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(Message message) {
                ...
                if(percent == 100){
                    ...
                    progessBarPercent.setProgress(100);
                }
                else
                {
                ...
                progessBarPercent.setProgress(percent);
                return true;
            }
        });
    }
    ...
    private void doDrawMultiThreading() {
        ...
        progessBarPercent.setProgress(0);
    ...
    private void addViews() {
        ...
        progessBarPercent=findViewById(R.id.progressBarPercent);
