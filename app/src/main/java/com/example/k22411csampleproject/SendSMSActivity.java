...
public class SendSMSActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        imgSendSms1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // ko quan tâm thành công hay thất bại
    ...
    public  void sendSms(TelephonieInfor ti, String content)
    {
    ...
    public  void sendSmsPendingIntent(TelephonieInfor ti, String content)
    {
...
//Gọi hàm gửi tin nhắn đi
    ...
    private void addViews() {
        ...
        ti=(TelephonieInfor) intent.getSerializableExtra("TI");
        if (ti!=null)
        {
