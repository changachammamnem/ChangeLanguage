...
public class Product implements Serializable {
    ...
    public Product(int id, String name, int quantity, double price, int cate_id, String dscription) {
        this.id = id;
        this.name = name;
    ...
    public Product(String name, int quantity, double price, int image_id, int id) {
        this.name = name;
        this.quantity = quantity;
        this.price = price;
        this.image_id = image_id;
