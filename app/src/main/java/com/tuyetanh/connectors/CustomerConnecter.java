...
public class CustomerConnecter {
    ListCustomer listCustomer;
    public CustomerConnecter()
    {
    ...
    /**
     * Đây là hàm truy vấn toàn bộ dữ liệu khách hàng sau đó mô hình lại hướng đối tượng
     * @param database
    ...
    //chỉ xoá khách hàng ko có dữ liệu liên kết
}
